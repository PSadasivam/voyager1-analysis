#!/usr/bin/env python3
"""
voyager1_astropy_science_enhanced.py
---------------------------------

Enhanced version of the Voyager 1 data visualization script with support for
fetching real data from NASA's PDS/SPDF archives.
...
comma‑separated values (CSV) files or Common Data Format (CDF) files.  The
...
Run time (real time): 
python voyager1_astropy_science_enhanced.py --real-data --days-back 30

Run time (unit test): 
python -m unittest voyager1_astropy_science_enhanced.py
